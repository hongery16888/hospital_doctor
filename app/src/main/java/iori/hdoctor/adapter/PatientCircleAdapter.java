...
public class PatientCircleAdapter extends BaseAdapter {
	...
	private ArrayList<PatCircle> data = new ArrayList<>();
	private Context context;
	private ImageLoader imageLoader = ImageLoader.getInstance();
	private DisplayImageOptions options;
	private Handler handler;

	public PatientCircleAdapter(Context context, ArrayList<PatCircle> patCircles, Handler handler) {
	...
	@Override public View getView(int position, View view, ViewGroup parent) {
		...
		if (view != null) {
			...
			view = LayoutInflater.from(context).inflate(R.layout.patient_circle_item, parent, false);
	...
	public void setData(ArrayList<PatCircle> patCircles){
		data.clear();
		data.addAll(patCircles);
