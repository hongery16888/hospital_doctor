...
public class PatientCircleInfoAdapter extends BaseAdapter {

	private ArrayList<PatContent> data = new ArrayList<>();
	private Context context;
	private ImageLoader imageLoader = ImageLoader.getInstance();
	private DisplayImageOptions options;

	public PatientCircleInfoAdapter(Context context, ArrayList<PatContent> patContents) {
