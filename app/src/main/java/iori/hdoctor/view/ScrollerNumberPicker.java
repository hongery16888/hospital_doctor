...
public class ScrollerNumberPicker extends View {
	...
	private void drawMask(Canvas canvas) {
		LinearGradient lg = new LinearGradient(0, 0, 0, maskHight, 0xfff2f2f2,
		...
		LinearGradient lg2 = new LinearGradient(0, controlHeight - maskHight,
				0, controlHeight, 0x00f2f2f2, 0xfff2f2f2, TileMode.MIRROR);
	...
	private void init(Context context, AttributeSet attrs) {
		TypedArray attribute = context.obtainStyledAttributes(attrs,
				R.styleable.SuNumberPicker);
		unitHeight = (int) attribute.getDimension(
				R.styleable.SuNumberPicker_unitHight, 32);
		normalFont = attribute.getDimension(
				R.styleable.SuNumberPicker_normalTextSize, 14.0f);
		selectedFont = attribute.getDimension(
				R.styleable.SuNumberPicker_selecredTextSize, 22.0f);
		itemNumber = attribute.getInt(R.styleable.SuNumberPicker_itemNumber, 7);
		normalColor = attribute.getColor(
				R.styleable.SuNumberPicker_normalTextColor, 0xff000000);
		selectedColor = attribute.getColor(
				R.styleable.SuNumberPicker_selecredTextColor, 0xffff0000);
		lineColor = attribute.getColor(R.styleable.SuNumberPicker_lineColor,
				0xff000000);
		maskHight = attribute.getDimension(
				R.styleable.SuNumberPicker_maskHight, 48.0f);
		noEmpty = attribute.getBoolean(R.styleable.SuNumberPicker_noEmpty,
				false);
		isEnable = attribute.getBoolean(R.styleable.SuNumberPicker_isEnable,
				true);
		attribute.recycle();
