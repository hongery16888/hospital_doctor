 ...
 */
public class PatientZWZD07Activity extends BaseActivity implements SeekBar.OnSeekBarChangeListener{
    ...
    @InjectView(R.id.indirectness)
    TextView indirectness;
    @InjectView(R.id.odds_info)
    TextView oddsInfo;

    @Override
    protected int setContentViewResId() {
        return R.layout.patient_zwzd_07_main;
    }
    ...
    public void onProgressChanged(SeekBar seekBar, int progress, boolean fromUser) {
        indirectness.setText(progress + getResources().getString(R.string.patient_zwzd_piss_odds_unit));
        if (progress < 30)
