 ...
 */
public class PatientZWZD10Activity extends BaseActivity implements SeekBar.OnSeekBarChangeListener{

    @OnClick(R.id.next_step)
    public void nextStep() {
        getApp().setActivities(this);
        startActivity(new Intent(PatientZWZD10Activity.this, PatientZWZD11Activity.class));
    }
    ...
    protected int setContentViewResId() {
        return R.layout.patient_zwzd_10_main;
    }
    ...
    public void onProgressChanged(SeekBar seekBar, int progress, boolean fromUser) {
        forced.setText(progress + getResources().getString(R.string.patient_zwzd_piss_odds_unit));
        if (progress < 30)
