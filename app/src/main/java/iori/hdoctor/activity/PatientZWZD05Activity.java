 ...
 */
public class PatientZWZD05Activity extends BaseActivity implements SeekBar.OnSeekBarChangeListener{
    ...
    protected int setContentViewResId() {
        return R.layout.patient_zwzd_05_main;
    }
    ...
    public void onProgressChanged(SeekBar seekBar, int progress, boolean fromUser) {
            odds.setText(progress + getResources().getString(R.string.patient_zwzd_piss_odds_unit));
            if (progress < 30)
