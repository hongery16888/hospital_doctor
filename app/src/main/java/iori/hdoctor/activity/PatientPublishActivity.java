...
public class PatientPublishActivity extends BasePhotoCropActivity implements NetworkConnectListener{
    ...
    protected int setContentViewResId() {
        return R.layout.patient_publish_main;
    }
    ...
    public View.OnClickListener publishListener = new View.OnClickListener() {
        ...
        public void onClick(View v) {
            if (TextUtils.isEmpty(content.getText().toString()))
                ...
                if (flag)
                    NetworkAPI.getNetworkAPI().circlepublish(content.getText().toString(), checkBox.isChecked() ? "1" : "0", showProgressDialog(), PatientPublishActivity.this);
                else
                    NetworkAPI.getNetworkAPI().circlepublishnoimg(content.getText().toString(), checkBox.isChecked() ? "1" : "0", showProgressDialog(), PatientPublishActivity.this);
            }
        }
    };
