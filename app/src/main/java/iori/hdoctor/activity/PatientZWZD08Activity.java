 ...
 */
public class PatientZWZD08Activity extends BaseActivity implements SeekBar.OnSeekBarChangeListener{
    ...
    public void nextStep() {
        ...
        startActivity(new Intent(PatientZWZD08Activity.this, PatientZWZD09Activity.class));
    }
    ...
    protected int setContentViewResId() {
        return R.layout.patient_zwzd_08_main;
    }
    ...
    public void onProgressChanged(SeekBar seekBar, int progress, boolean fromUser) {
        urination.setText(progress + getResources().getString(R.string.patient_zwzd_piss_odds_unit));
        if (progress < 30)
