 ...
 */
public class DoctorForgetPwdActivity extends BaseActivity implements NetworkConnectListener{
    ...
    public void nextStep(){
        if (!TextUtils.isEmpty(verify.getText().toString()) && verify.getText().toString().equals(verifyCode)){
            Intent intent = new Intent(this, DoctorResetPasswordActivity.class);
    ...
    protected int setContentViewResId() {
        return R.layout.doctor_forget_password_main;
    }
