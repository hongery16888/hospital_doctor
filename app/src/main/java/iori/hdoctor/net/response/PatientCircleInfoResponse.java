 ...
 */
public class PatientCircleInfoResponse {
    ...
    private String best;
    private ArrayList<PatContent> pinglunlist;
    ...
    public ArrayList<PatContent> getPinglunlist() {
        return pinglunlist;
    }

    public void setPinglunlist(ArrayList<PatContent> pinglunlist) {
